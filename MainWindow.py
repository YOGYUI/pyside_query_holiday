...
class MainWindow(QMainWindow):
    ...
    def initLayout(self):
        ...
        grbox = QGroupBox()
        grbox.setSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Fixed)
        ...
        self._spinYear.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.MinimumExpanding)
    ...
    def initControl(self):
        ...
        self._editKey.setEchoMode(QLineEdit.EchoMode.Password)
        ...
        self._tableResult.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        self._tableResult.horizontalHeader().setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)
        self._tableResult.horizontalHeader().setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)
